<?php
/**
 * Template Name: Webinar Landing Template
 */
?>
 ...
 ?>
  ...
  <div class="container clearfix workshop-top">
    ...
    <div class="col-md-6">
        ...
        <?php
          $event_cats_objects = get_field('webinar_calendar_category');
      	  $event_cats = array();
        ...
        <div class="workshop-topics-wrap clearfix">
          ...
          <div class="inset clearfix">
              ...
              // loop through the rows of data
        	    while ( have_rows('webinars_lists') ) : the_row(); ?>
                        ...
                        <a title="<?php echo $box['title']; ?>" class="" href="<?php echo $boxLink; ?>">
                          <?php
                            if(strlen($box['title']) >= 44) {
                              $truncatedTitle = trim(substr($box['title'], 0, 434))."...";
                              echo $truncatedTitle;  
                            } else {
                              echo $box['title'];
                            }
